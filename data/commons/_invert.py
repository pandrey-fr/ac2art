...
"""Set of functions wrapping acoustic-to-articulatory inversion tasks."""
...
from data.commons.abkhazia.utils import copy_feats, read_ark_file
from neural_networks.core import DeepNeuralNetwork, load_dumped_model
from utils import check_type_validity


def ac2art_inversion(
    ...
    inverter      : DeepNeuralNetwork-inheriting instance, or path to
    ...
    check_type_validity(inverter, (DeepNeuralNetwork, str), 'inverter')
